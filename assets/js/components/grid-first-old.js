...
(function ($) {
  ...
  $(document).on('ready', function () {
    ...
    if (windowWidth <= 992) {
      $('.js-custom-scroll-horizontal').mCustomScrollbar({
        axis: 'x',
        mouseWheel: {
          axis: 'x'
        },
        mouseWheelPixels: 500,
        setLeft: windowWidth <= 768 ? '-275px' : 0,
        advanced: {
        ...
        callbacks: {
          whileScrolling: function () {
            if (this.mcs.leftPct >= 90) {
              $.getJSON('/reso/ajax/galleryList.json', function (data) {
                if (i3 < data.length) {
      ...
      $('.js-custom-scroll-horizontal').mCustomScrollbar('destroy');
    }

    if (windowWidth >= 993) {
      $('.dashboard__items_inner').mCustomScrollbar({
        mouseWheelPixels: 500,
        callbacks: {
          whileScrolling: function () {
      ...
      $('.dashboard__items_inner').mCustomScrollbar('destroy');
    }
  });
})(jQuery);